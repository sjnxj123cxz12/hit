...
var i = Math.floor(this.getRandomRange(o, n));
Math.floor(this.getRandomRange(o, n));
this.spawnChipsToArea(t, i);
};
...
if (0 == s.VoltaConst.isLoading && 0 == this.isSpawnChipFrist && 0 == this.isShowResult && t.Ellapsed > 5) {
this.isSpawnChipFrist = !0;
var c = function(t) {
return t < 1e6 ? 0 : t < 1e7 ? 1 : t < 5e7 ? 2 : t < 1e8 ? 3 : t < 2e8 ? 4 : 5;
}, p = c(n), h = c(a);
l.default.instance.addChipsByCondition(1, h);
l.default.instance.addChipsByCondition(2, p);
}
}
};
